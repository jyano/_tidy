...
//////
	...
	function under() {
		((function fn() {//     Underscore.js 1.8.3
			...
			////////// used by backbone: ///////////////
			_.z = _.size = function (obj) {
				return (obj == null) ? 0 : isArrayLike(obj) ? obj.length : _.keys(obj).length
			}
			...
			_.uI = _.uniqueId = function (prefix) {
				var id = ++idCounter + '';
			...
			var optimizeCb = function (fn, ctx, argCount) {
				...
				switch (argCount == null ? 3 : argCount) {
					case 1:
						return function (v) {
							return fn.call(ctx, v)
						}
					case 2:
						return function (v, other) {
							return fn.call(ctx, v, other)
						}
					case 3:
						return function (v, ix, cl) {
							return fn.call(ctx, v, ix, cl)
						}
					case 4:
						return function (accumulator, v, ix, cl) {
							return fn.call(ctx, accumulator, v, ix, cl)
						}
				}
				return function () {
			...
			var cb = function (v, ctx, argCount) {
				return (v == null) ? _.identity : _.isFunction(v) ? optimizeCb(v, ctx, argCount) : _.isObject(v) ? _.matcher(v) : _.property(v)
			}
			...
			_.e(['Arguments', 'Function', 'String', 'Number', 'Date', 'RegExp', 'Error'], function (n) {
				_['is' + n] = function (obj) {
			...
			var group = function (behavior) {
				return function (ob, iteratee, ctx) {
					var result = {};
					iteratee = cb(iteratee, ctx);
					_.e(ob, function (value, index) {
						var key = iteratee(value, index, ob);
			...
			_.es = _.escape = createEscaper(escapeMap);
			...
			_.e(['pop', 'push', 'reverse', 'shift', 'sort', 'splice', 'unshift'], function (n) {
				...
				_.prototype[n] = function () {
					...
					method.apply(ob, arguments);
					if ((n === 'shift' || n === 'splice') && ob.length === 0) {
						delete ob[0]
					}
			...
			function createReduce(dir) {
				...
				return function (obj, iteratee, memo, ctx) {
					iteratee = optimizeCb(iteratee, ctx, 4);
